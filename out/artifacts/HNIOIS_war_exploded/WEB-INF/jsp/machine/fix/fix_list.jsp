...
<div class="hniois-table">
    <form action="fix/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'fix/add')}">
                ...
                <c:if test="${fn:contains(QX,'fix/delete')}">
                ...
                <c:if test="${fn:contains(QX,'fix/approve')}">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="applyer" placeholder="申请人.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="app_time" id="test1" placeholder="yyyy-MM-dd" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">审批人</label>
                    <div class="layui-input-block">
                        <input type="text" name="appver"  autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">审批状态</label>
                    <div class="layui-input-block">
                        <select name="status" id="sta"  lay-search="">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'fix/update')}">
...
<script>
        ...
        data_table = table.render({
            ...
            cols: [[
               ...
               // {field:'id', title: '序号'},
                ...
                {field:'mach_name',  title: '仪器名', align:'center'},
                {field:'analysis',  title: '申请原因', align:'center'},
                {field:'applyer',  title: '申请人', align:'center'},
                {field:'app_time',  title: '申请时间', align:'center'},
                {field:'cost',  title: '申请费用',edit:'text', align:'center'},
                ...
                {field:'type',  title: '申请类型', align:'center'},
                {fixed: 'right', width: 165, align:'center', templet:function(d){
                        var str=d.status;
                        if(str=="通过"||str=="驳回"){
                            return $("#editBar2").html();
                        }else{
                            return $("#editBar").html();
                        }
                    }}
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "fix/toEdit.do?mach_id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
    ...
    function doApprove(){
        ...
        layui.layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "fix/approve.do?data="+ids.toString(),
            area: ['650px', '80%']
        })
    }
