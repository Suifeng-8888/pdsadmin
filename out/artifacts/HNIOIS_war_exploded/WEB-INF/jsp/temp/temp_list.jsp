...
<div class="hniois-table">
    <form action="temp/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'temp/add')}">
                ...
                <c:if test="${fn:contains(QX,'temp/delete')}">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'temp/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'temp_id',  title: '模版KEY'},
                {field:'temp_name',  title: '模版名称'},
                {field:'temp_comment',  title: '模版注释'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'temp/update')}"=="true"){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "temp/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
