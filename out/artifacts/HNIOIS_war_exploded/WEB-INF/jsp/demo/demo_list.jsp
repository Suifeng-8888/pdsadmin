...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1,minimum-scale=1, demo-scalable=no">
...
<div class="hniois-table">
    <form action="demo/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <%--<c:if test="${fn:contains(QX,'demo/add')}">--%>
                ...
                <%--</c:if>--%>
                <%--<c:if test="${fn:contains(QX,'demo/delete')}">--%>
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="demoname" placeholder="搜索模版名.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="demo_id" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">电话</label>
                    <div class="layui-input-block">
                        <input type="text" name="phone" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">角色</label>
                    <div class="layui-input-block">
                        <select name="role_id" id="hniois-role-select" lay-search="" class="hniois-search-data">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'demo_id',  title:'字段key',width:120,sort:true},
                {field:'demoname', title: '字段',edit:'text',width:160},
        ...
        table.on('tool(lay_table)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(layEvent === 'detail'){
                ...
                toChangeDemoImgs(data.id)
            }
        });

        //监听单元格编辑
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'demo/update')}"=="true"){
                var field = obj.field , //得到字段
                    value = obj.value ,//得到修改后的值
                    data = obj.data ;//得到所在行所有键值
                var obj = new Object();
                obj.demo_id = data.demo_id;
                obj[field] = value;
                //修改数据
                doEdit(obj);
            }else {
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "demo/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
