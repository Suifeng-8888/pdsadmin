    ...
    <form action="pro_record/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'pro_record/add')}">
                ...
                <c:if test="${fn:contains(QX,'pro_record/delete')}">
                ...
                <a id="hniois-export" onclick="doExport('pro_record/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
        ...
        <div class="hniois-search-mored layui-anim layui-anim-upbit">
            <div class="hniois-search-body">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">生产批次数</label>
                    <div class="layui-input-block">
                        <input type="text" name="patch_num" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'pro_record/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'rec_id',  title:'序号',align:"center"},
                ...
                {field:'patch_num', title: '生产批次数',edit:'text',align:"center"},
                {field:'address',  title: '生产地址',edit:'text',align:"center"},
                {field:'st_time',  title: '开始生产时间',align:"center"},
                {field:'end_time',  title: '结束生产时间',edit:'text',align:"center"},
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "pro_record/toEdit.do?rec_id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
