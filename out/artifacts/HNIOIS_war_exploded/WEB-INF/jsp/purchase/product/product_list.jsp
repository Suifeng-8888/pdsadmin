...
<div class="hniois-table">
    <form action="product/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'product/add')}">
                ...
                <%--<c:if test="${fn:contains(QX,'product/add')}">--%>
                    <%--<a id="batch_add"  class="layui-btn layui-btn-sm layui-btn-normal" href="javascript:;">--%>
                        <%--<i class="fa fa-plus fa-lg" aria-hidden="true"></i> 批量新增</a>--%>
                <%--</c:if>--%>
                <c:if test="${fn:contains(QX,'product/delete')}">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="pro_name" placeholder="搜索产品名.." autocomplete="off"/>
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="pro_id" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="statement" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'product/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'pro_name',  title: '产品名',edit:'text'},
                {field:'bar_code',  title: '产品条形码',edit:'text'},
                {field:'pro_unit',  title: '产品规格',edit:'text'},
                {field:'statement',  title: '说明',edit:'text'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'product/update')}"=="true"){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "product/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
