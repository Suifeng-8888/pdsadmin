...
<div class="hniois-table">
    <form action="tempFiled/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'tempFiled/add')}">
                ...
                <c:if test="${fn:contains(QX,'tempFiled/delete')}">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="demo_name" placeholder="搜索条件.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="demo1" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">查询条件2</label>
                    <div class="layui-input-block">
                        <input type="text" name="demo2" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'tempFiled/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            elem: '#table',
            url:'tempFiled/list.do',
            cols: [[
                {type:'checkbox'},
                {field:'temp_id',  title: '模版'},
                {field:'filed_id',  title: 'Key'},
                {field:'filed_name',  title: '名称'},
                {field:'filed_type',  title: '类型'},
                {field:'filed_order',  title: '长度'},
                {field:'filed_comment',  title: '注释'},
                {field:'filed_default',  title: '默认值'},
                {field:'filed_check',  title: '验证'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'tempFiled/update')}"=="true"){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "tempFiled/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
