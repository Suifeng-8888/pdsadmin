    ...
    <form action="user/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'user/add')}">
                ...
                <c:if test="${fn:contains(QX,'user/delete')}">
                ...
                <c:if test="${fn:contains(QX,'user/export')}">
                    <a id="hniois-export" onclick="doExport('user/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
                        <i class="fa fa-cloud-download fa-lg" aria-hidden="true"></i> 导出</a>
                </c:if>
            </div>
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="username" placeholder="搜索用户名.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="user_id" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'user/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'user_img', title: '头像',width:60,templet:function(d){
                        var str = '<div class="layui-inline"  lay-event="imgs">\n' +
                            '  <img class="layui-nav-img user-imgs" src="'+d.user_img+'" class="layui-nav-img" style="background-color: black">\n' +
                            '</div>';
                        return str + "";
                    }},
    ...
    function toChangeUserImgs(id){
        ...
        layer.open({
            ...
            maxmin: true,
            skin: 'layui-layer-rim', //加边框
            content: "user/toEditImgs.do?id="+id,
            area: ['400px', '320px']
        });
    }
