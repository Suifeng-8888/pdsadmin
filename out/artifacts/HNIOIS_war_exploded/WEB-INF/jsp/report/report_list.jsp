    ...
    $(document).ready(function () {
        ...
        data_table = table.render({
           ...
           url: 'report/list.do',
            cols: [[
            {type:'checkbox'},
            {field:'record_id', title:'ID',sort:true, align:"center",width:80},
            ...
            {field:'detection_type', title: '检验类别',align:"center",width:150},
            ...
            {fixed: 'right', title: '操作', align:"center",width:180, toolbar: '#editBar'}
        ]],
