...
<div class="hniois-table">
    <form action="retailer/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="licence" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">联系人</label>
                    <div class="layui-input-block">
                        <input name="contact" class="layui-input hniois-search-data" type="text" autocomplete="off">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'id',  title:'销售商ID'},
                {field:'name',  title: '销售商名称',align:"center"},
                {field:'licence', title: '生产许可证号',align:"center"},
    ...
    function sendMsg(){
        ...
        if (d.data.length === 0) {
            layui.layer.msg('请选择销售商');
            return;
        }
        if (d.data.length >1) {
            layui.layer.msg('请选择1个销售商');
            return;
        }
        var data = d.data,
            ids=[],
        ...
        parent.$('#sale_id').val(ids.toString());
