...
<div >
    <form class="layui-form layui-form-pane" action="" >
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">样品分类ID<span style="color: #FF5722">*</span></label>
            ...
            <label class="layui-form-label">操作人<span style="color: #FF5722">*</span></label>
            <div class="layui-input-block">
                <input name="person" class="layui-input" type="text" autocomplete="off"
                       lay-verify="required" value="${cate.person}">
            </div>
            <div id="create">
