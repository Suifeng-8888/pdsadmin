        ...
        <div class="hniois-table-header">
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="endTime" id="dtime" placeholder="选择年月" />
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            elem: '#table',
            url: 'summary/monthlist.do',
            cols: [[
                {field:'temp', title:'月份',width:150},
                {field:'num', title: '报告数',width:150}
            ]],
