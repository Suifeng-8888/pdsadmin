    ...
    <form action="${demo}/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${r"${fn:contains(QX,'"}${demo}${r"/add')}"}">
                ...
                <c:if test="${r"${fn:contains(QX,'"}${demo}${r"/delete')}"}">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${r"${fn:contains(QX,'"}${demo}${r"/update')}"}">
...
<#list fieldList as e>
        ...
        table.on('edit(lay_table)', function(obj){
            if("${r"${fn:contains(QX,'"}${demo}${r"/update')}"}"=="true"){
