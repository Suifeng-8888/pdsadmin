    ...
    <form action="supply/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <c:if test="${fn:contains(QX,'supply/export')}">
                    <a id="hniois-export" onclick="doExport('supply/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'sup_id',  title: '供应商ID'},
                {field:'name',  title: '供应商名字',edit:'text'},
                {field:'address',  title: '供应商地址',edit:'text'},
