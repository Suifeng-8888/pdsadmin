    ...
    <form action="" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                ...
                <i class="fa fa-plus fa-lg" aria-hidden="true"></i>&nbsp;添加销售商</a>
                ...
                <a id="hniois-export" onclick="doExport('retailer/doExport')" class="layui-btn layui-btn-sm layui-bg-orange" href="javascript:;" >
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="name" placeholder="销售商名称.." />
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            elem: '#table',
            url:'retailer/list.do',
            cols: [[
                {type:'checkbox'},
                {field:'id', title:'ID',sort: true, width: 60 },
                {field:'name', title:'销售商名称',width: 160},
                {field:'licence', title: '生产许可证号',width: 120},
                {field:'organization', title: '组织机构代码',width: 120},
                {field:'site', title: '销售商地址',width: 160},
                {field:'phone', title: '联系电话',width: 120},
                {field:'email', title: '邮箱',width: 120},
                {field:'contact', title: '联系人',width: 80},
                {field:'publicity', title: '是否公开', width: 100, templet: function (d) {
                    if(d.publicity == 1) {
                        return "是";
                    } else if(d.publicity == 2) {
                        return "否";
                    } else {
                        return "";
                    }
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "retailer/toEdit.do?id="+id+"&code="+code,
            area: ['750px', '80%']
        });
    }
