            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="record_num" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="btime" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    ...
    <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="mark">追溯二位码</a>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'record_id', title: '生产记录ID',width:150,align:"center"},
                {field:'record_num', title: '生产记录号',width:150,align:"center"},
                ...
                {field:'batch_num', title: '加工数量',edit:'text',width:150,align:"center"},
