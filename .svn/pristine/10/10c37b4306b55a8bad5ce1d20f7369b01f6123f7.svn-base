...
<form class="layui-form layui-form-pane" action="" >
    ...
    <%--<div class="layui-form-item">--%>
        ...
        <div class="layui-input-block">
            <input name="norm_number" class="layui-input" type="text" autocomplete="off"
                   lay-verify="required" value="${norm.norm_number}">
        </div>
    <%--</div>--%>
    <%--<div class="layui-form-item">--%>
        <label class="layui-form-label">标准名称<span style="color: #FF5722">*</span></label>
        <div class="layui-input-block">
            <input name="norm_name" class="layui-input" type="text" autocomplete="off"
                   lay-verify="required" value="${norm.norm_name}">
        </div>
