        ...
        var that = this,
            ...
            init = function(treeid) {
                ...
                var reElem = $([
                    ...
                    '<div class="' +TITLE +'">' +
                    '<input type="text" placeholder="' +placeholder +'" id="' +treeid +"_text" +
                    '" value="' +(value ? value : '') +'" readonly class="layui-input layui-unselect' +
                    (disabled ? (' ' + DISABLED) : '') +'">', '<i class="layui-edge"></i></div>',
