...
<div class="hniois-table">
    <form action="norm/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'norm/add')}">
                ...
                <c:if test="${fn:contains(QX,'norm/delete')}">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="norm_name" placeholder="搜索标准名.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="norm_number" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
            </div>
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'norm/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
                {field:'id',  title:'标准ID',sort: true, width: 100 },
                {field:'norm_number',  title:'标准编号'},
                {field:'norm_name', title: '标准名称',edit:'text'},
                {field:'norm_type', title: '标准类别'},
                // {field:'award_dept', title: '颁发部门'},
                {field:'norm_creator',  title: '创建者'},
                {field:'create_time', title: '创建时间'},
                {field:'norm_explain',  title: '备注',edit:'text'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${fn:contains(QX,'norm/update')}"=="true"){
