...
<div class="hniois-table">
    <form action="record/list.do" method="post" class="layui-form hniois-search-form" id="hniois-search-form">
        <div class="hniois-table-header">
            <div class="hniois-search-btns">
                <c:if test="${fn:contains(QX,'record/add')}">
                ...
                <c:if test="${fn:contains(QX,'record/delete')}">
            ...
            <div class="hniois-search-inputs">
                <div class="hniois-search-keyword">
                    <input type="text" class="layui-input hniois-search-data" name="people" placeholder="使用人.." />
            ...
            <div class="hniois-search-body">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="begin_time"  autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">仪器名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="mach_names" autocomplete="off" class="layui-input hniois-search-data">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'record/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                {type:'checkbox'},
              //  {field:'id', title: '序号'},
                {field:'mach_ids', title: '仪器编号',align:'center'},
                {field:'mach_names',  title: '所用仪器',align:'center'},
                {field:'people',  title: '使用人',edit:'text',align:'center'},
                {field:'for_use',  title: '用途',edit:'text',align:'center'},
                {field:'begin_time',  title: '使用时间',edit:'text',align:'center'},
                {field:'status',  title: '使用情况',align:'center',templet:function(d){
                    var str=d.status;
                    if(str=="正常"){
                        str="<span>正常</span>"
                    }else if(str=="故障"){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "record/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
