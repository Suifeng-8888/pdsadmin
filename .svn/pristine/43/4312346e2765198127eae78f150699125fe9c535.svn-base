...
<div class="hniois-table">
    ...
    <div class="hniois-table-header">
        <div class="hniois-search-btns">
            <c:if test="${fn:contains(QX,'cate/add')}">
            ...
            <c:if test="${fn:contains(QX,'cate/delete')}">
        ...
        <div class="hniois-search-inputs">
            <div class="hniois-search-keyword">
                <input type="text" class="layui-input hniois-search-data" name="typename" placeholder="搜索类名.." />
        ...
        <div class="hniois-search-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="typeid" autocomplete="off" class="layui-input hniois-search-data">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <%--<select name="role_id" id="hniois-role-select" lay-search="" class="hniois-search-data">--%>
                        <input type="text" name="typename" autocomplete="off" class="layui-input hniois-search-data">
                    <%--</select>--%>
                </div>
            </div>
        </div>
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'cate/update')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                //{field:'typeid',  title:'样品分类ID',edit:'text'},
                {field:'typename',  title: '分类名称',edit:'text'},
                {field:'status', title: '状态',templet:function(d){
                        var str = '<input type="checkbox" name="lock" value="'+d.id+'"' +
                            ' title="启用" lay-filter="lay_state" ' +(d.status=="0"?"checked":"") + ' >';
                        return str + "";
                    }},
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "cate/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
