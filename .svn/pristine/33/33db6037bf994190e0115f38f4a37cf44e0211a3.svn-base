...
<div >
    <form class="layui-form layui-form-pane" action="" >
        ...
        <%--<div class="layui-form-item">--%>
            <label class="layui-form-label">出入库单号<span style="color: #FF5722">*</span></label>
            <div class="layui-input-block">
                <input name="odd_number" class="layui-input" type="text" autocomplete="off" value="" lay-verify="required">
            </div>
        <%--</div>--%>
        <%--<div class="layui-form-item">--%>
        ...
        <c:if test="${repertory.sort == 1}">
            ...
            <%--</div>--%>
            <%--<div class="layui-form-item">--%>
                <label class="layui-form-label">入库数量<span style="color: #FF5722">*</span></label>
                <div class="layui-input-block">
                    <input name="stock" class="layui-input" type="text" autocomplete="off" lay-verify="required" value="${repertory.stock}"
        ...
        <c:if test="${repertory.sort == 2}">
            ...
            <%--<div class="layui-form-item">--%>
                ...
                <div class="layui-input-block">
                    <input name="stock" id="instock" class="layui-input" type="text" autocomplete="off"
                           lay-verify="required" value="${repertory.stock}" readonly="readonly">
                </div>
            <%--</div>--%>
            <%--<div class="layui-form-item">--%>
                <label class="layui-form-label">入库数量<span style="color: #FF5722">*</span></label>
                <div class="layui-input-block">
                    <input name="inrep" id="inrep" class="layui-input" type="text" autocomplete="off" lay-verify="required" value=""
        ...
        <c:if test="${repertory.sort == 3}">
            <%--<div class="layui-form-item">--%>
                <label class="layui-form-label">库存数量<span style="color: #FF5722">*</span></label>
                <div class="layui-input-block">
                    <input name="stock" id="outstock" class="layui-input" type="text" autocomplete="off"
                           lay-verify="required" value="${repertory.stock}" readonly="readonly">
                </div>
            <%--</div>--%>
            <%--<div class="layui-form-item">--%>
                <label class="layui-form-label">出库数量<span style="color: #FF5722">*</span></label>
                <div class="layui-input-block">
                    <input name="outrep" id="outrep" class="layui-input" type="text" autocomplete="off" lay-verify="required" value=""
                           onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" onchange="fnoutrep();">
                </div>
            <%--</div>--%>
            <%--<div class="layui-form-item">--%>
                <label class="layui-form-label">领取人<span style="color: #FF5722">*</span></label>
                <div class="layui-input-block">
                    <input name="get_name" class="layui-input" type="text" autocomplete="off" lay-verify="required" value="">
                </div>
            <%--</div>--%>
        </c:if>
        <%--<div class="layui-form-item">--%>
...
<script type="text/javascript">
    ...
    //出库
    function fnoutrep() {
        var stockVal = parseInt($("#outstock").val());
        var outrepVal = parseInt($("#outrep").val().trim());
        var count = stockVal - outrepVal;
        if (count < 0) {
            parent.layer.msg("没有更多的库存量");
            return;
        }
        $("#outstock").val(stockVal - outrepVal);
    }
