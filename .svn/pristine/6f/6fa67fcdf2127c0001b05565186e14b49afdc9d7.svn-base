    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'mach_name',  title: '检定仪器名',edit:'text'},
                {field:'model',  title: '仪器型号',edit:'text'},
                {field:'sender',  title: '送检人',edit:'text'},
                {field:'send_time',  title: '送检时间',edit:'text'},
                {field:'check_time',  title: '到期检定时间',edit:'text'},
                {field:'check_state',  title: '检定状态',/*templet:function(d){
                    if(d.check_state==0){
                        return "已检定";
                ...
                {checked: 'right',  align:'center', toolbar: '#editBar'}
            ]],
