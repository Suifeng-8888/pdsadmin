...
<div class="hniois-table">
    ...
    <div class="hniois-table-header">
        <div class="hniois-search-btns">
            ...
            <c:if test="${fn:contains(QX,'finance/delete')}">
        ...
        <div class="hniois-search-inputs">
            <div class="hniois-search-keyword">
                <input type="text" class="layui-input hniois-search-data" name="pur_batch" placeholder="搜索批次号.." />
        ...
        <div class="hniois-search-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="approve" autocomplete="off" class="layui-input hniois-search-data">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="state" id="hniois-role-select" lay-search="" class="hniois-search-data">
...
<script type="text/html" id="editBar">
    ...
    <c:if test="${fn:contains(QX,'finance/update')}">
    <a class="layui-btn layui-btn-xs" lay-event="edit">审批编辑</a>
    </c:if>
    <c:if test="${fn:contains(QX,'finance/delete')}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        data_table = table.render({
            ...
            cols: [[
                ...
                {field:'pro_name', title: '采购的商品'},
                {field:'pur_batch', title: '采购批次号'},
                {field:'pur_num', title: '采购总数量'},
                {field:'price',  title: '采购总价格'},
        ...
        table.on('edit(lay_table)', function(obj){
            if("${QX}".indexOf("finance/update")!=-1){
    ...
    function toEdit(id,code){
        ...
        layer.open({
            ...
            content: "finance/toEdit.do?id="+id+"&code="+code,
            area: ['650px', '80%']
        });
    }
